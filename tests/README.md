...
- `blender/smoke/`: 94 end-to-end or focused regression scripts.
...
pme_missing_property_draw_smoke.py
pme_modes_smoke.py
pme_editor_keymap_smoke.py
pme_user_keymap_cleanup_smoke.py
pme_poll_consistency_smoke.py
pme_poll_context_smoke.py
pme_macro_missing_operator_smoke.py
...
pme_disable_reenable_data_smoke.py
pme_command_generate_storage_smoke.py
pme_macro_public_proxy_smoke.py
```
